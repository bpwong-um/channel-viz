(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'uNrFCXLnAa2XKu4IfatmrFXNpLLpoaA8qNrZAgfnH9M8xSYL', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1821537225], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'kLabUM Test', // Replaces Xively logo in the header
		...
		dataColor	= 'FFFF00', // CSS HEX value of color to represent data (omit leading #)
